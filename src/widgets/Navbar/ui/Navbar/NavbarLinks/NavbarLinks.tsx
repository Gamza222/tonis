    ...
    <nav className={classNames(cls.NavbarLinks, {}, [className])}>
      {width > 1350 ? (
        ...
        <>
          ...
          >
            <ButtonType1 className={cls.NavbarLinkButton}>
          ...
          <HashLink
            ...
            to="/#tariffs"
          >
            <ButtonType1 className={cls.NavbarLinkButton}>Тарифы</ButtonType1>
          </HashLink>
          <HashLink
            onClick={closeNavbar}
            to="/#questions"
            className={cls.MobileLink}
          >
            <ButtonType1 className={cls.NavbarLinkButton}>Вопросы</ButtonType1>
          </HashLink>
        </>
      )}
    </nav>
